    ...
    >
      {badge && (
        <motion.span 
          ...
          className="inline-flex items-center px-4 py-1.5 mb-4 rounded-full text-xs font-semibold tracking-wider uppercase bg-primary-50 text-primary border border-primary-100"
        >
          {badge}
        </motion.span>
      )}
